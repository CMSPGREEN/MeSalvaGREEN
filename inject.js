(function () {
    ...
    function addDynamicCSS() {
        ...
        style.textContent = `
            #scriptToggleButton {
                ...
                padding: 10px 20px;
                cursor: pointer;
                box-shadow: 0 0 10px rgba(1, 255, 72, 0.5);
                display: flex;
                align-items: center;
    ...
    function createToggleButton() {
        ...
        infoPopup.innerHTML = `
            <strong style="color: #01ff48; font-family: 'Courier New', monospace;">Me Salva GREEN</strong>
            <p style="color: #fff; font-family: 'Courier New', monospace;"><strong>Criador:</strong> <span id="creatorName" style="color: #01ff48;">CMSPGREEN</span></p>
            <p style="color: #fff; font-family: 'Courier New', monospace;"><strong>Instagram:</strong> <a href="https://www.instagram.com/cmsp.green/?utm_source=ig_web_button_share_sheet" target="_blank" style="color: #01ff48; text-decoration: none;">@CMSP.GREEN</a></p>
        `;
